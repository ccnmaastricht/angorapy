...
def load_dataset(path):
    ...
    def _parse_function(example_proto):
        ...
        return tf.reshape(parsed["sim_state"], (VISION_WH, VISION_WH, -1)), tf.reshape(parsed["pose"], (7,))
...
def load_unrendered_dataset(path):
    ...
    def _parse_function(example_proto):
        ...
        return tf.reshape(parsed["sim_state"], (-1,)), tf.reshape(parsed["pose"], (7,))
...
def gen_cube_quats_prediction_data(n: int, save_path: str):
    ...
    with tf.io.TFRecordWriter(save_path) as writer:
        ...
        for i in tqdm(range(n), desc="Sampling Data"):
            ...
            example = serialize_example(tf.io.serialize_tensor(sim_state), tf.io.serialize_tensor(quaternion))
...
if __name__ == '__main__':
    ...
    data = gen_cube_quats_prediction_data(1000, "../storage/data/pretraining/pose_data.tfrecord")
    print(data)
