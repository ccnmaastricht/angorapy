...
class Monitor:
    ...
    def make_metadata(self, additional_hps: dict = None):
        ...
        metadata = dict(
            ...
            n_cpus=MPI.COMM_WORLD.size if MPI is not None else 1,
            ...
            hyperparameters=dict(
                ...
                reward_norming=str(any([isinstance(t, RewardNormalizer) for t in self.env.postprocessors])),
                state_norming=str(any([isinstance(t, StateNormalizer) for t in self.env.postprocessors])),
